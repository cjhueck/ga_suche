 ...
 * Visualizes theme intensity between 1882 and 1925
 */
...
var SteinerThemesData = [
    {
        theme: "Abstammung / Evolution",
        ranges: [
            { start: 1882, end: 1924, intensity: 0.7 }
        ],
        query: "Abstammung Evolution Haeckel Mensch_und_Tier"
    },
            {
        ...
        query: "Akasha Okkulte Geschichte Akasha-Chronik"
    },
    {
        theme: "Anthroposophie",
        ranges: [
            { start: 1903, end: 1924, intensity: 0.8 }
        ],
        query: "Anthroposophie Geisteswissenschaft Geheimwissenschaft"
    },
{
        theme: "Anthroposophische Gesellschaft",
        ranges: [
    ...
    },
{
        ...
        ranges: [
            { start: 1910, end: 1925, intensity: 0.8 },
            { start: 1912, end: 1914, intensity: 1.0 }
        ],
        query: "Eurythmie Sprachgestaltung Menschheitsrepräsentant Organische_Architektur Malen_aus_der_Farbe"
    },
    {
        ...
        query: "Wachen Träumen Schlafen Trance Somnambulismus Erweitertes Bewusstsein Schauendes_Bewusstsein"
    },
{
        ...
        query: "Bibel Evangelien Bergpredigt Paulus Prolog Johannes-Evangelium Vaterunser Seligpreisungen Neues_Testament Altes_Testament Zehn_Gebote Markus-Evangelium Lukas-Evangelium Matthäus-Evangelium"
    },
        {
        theme: "Biographie",
        ranges: [
        ...
        query: "Zahnwechsel Geschlechtsreife Rubikon Jahrsiebte Ich-Geburt Nachahmung Vorbild Nachfolge Autorität Urteilskraft Jüngerwerden_der_Menschheit"
    },
{
        theme: "Böses (Luzifer, Ahriman)",
        ranges: [
            { start: 1904, end: 1913, intensity: 0.6 },
            { start: 1914, end: 1924, intensity: 1.0 }
        ],
        query: "Luzifer Ahriman Böses Asuras"
    },
    {
        theme: "Christengemeinschaft",
        ranges: [
            { start: 1921, end: 1924, intensity: 1.0 }
        ],
        query: "Die_Christengemeinschaft Sakrament Ritus"
    },
        {
        theme: "Christentum",
        ranges: [
            { start: 1902, end: 1924, intensity: 0.8 }
        ],
        query: "Jesus Jordan-Taufe Abendmahl Lazarus Paulus Nikodemus Vaterunser Christus-Jesus"
    },
{
        theme: "Christus / Golgatha",
        ranges: [
            { start: 1902, end: 1924, intensity: 0.8 },
            { start: 1911, end: 1915, intensity: 1.0 }
        ],
        query: "Christus Golgatha Logos Weltenwort Auferstehung"
    },
    {
        theme: "Darwinismus",
        ranges: [
    ...
    },
{
        ...
        query: "Imagination Inspiration Intuition Gegenständliches Erkennen"
    },
{
        theme: "Erkenntnis / Erkenntnistheorie",
        ranges: [
            { start: 1882, end: 1894, intensity: 1.0 },
            { start: 1895, end: 1925, intensity: 0.4 }
        ],
        query: "Wahrnehmung Denken Erkennen Erkenntnistheorie Urteilskraft Wahrheit Irrtum Erkenntnisrätsel Grenzen_des_Erkennens Erkenntnismethode Erkenntnisweg Erkenntniskraft"
    },
    {
        theme: "Freiheitsphilosophie",
        ranges: [
            { start: 1890, end: 1895, intensity: 1.0 },
            { start: 1896, end: 1925, intensity: 0.3 }
        ],
        query: "Freiheit Philosophie_der_Freiheit Ethischer_Individualismus"
    },
        {
        theme: "Gehirn & Geist",
        ranges: [
            { start: 1883, end: 1924, intensity: 0.8 }
        ],
        query: "Gehirn Denken Geist Bewusstsein Abbau Astralleib Spiegelung"
    },
{
        theme: "Geistige Wesen",
        ranges: [
    ...
    },
    {
        ...
        query: "Astralwelt Devachan Geistige Welt Kamaloka Ätherwelt Mentale_Welt"
    },
        {
        theme: "Geistiges Erkennen",
        ranges: [
            { start: 1902, end: 1924, intensity: 0.8 }
        ],
        query: "Hellsehen Exakte_Clairvoyance Übersinnliche_Wahrnehmung"
    },
{
    ...
    },
    {
        ...
        ranges: [
            { start: 1882, end: 1916, intensity: 0.5 },
            { start: 1917, end: 1924, intensity: 1.0 }
        ],
        query: "Geschichte Kulturentwicklung Atlantis Lemuris Ägyptische Kultur Nachatlantische Kulturen Chaldäische Kultur Griechisch-römische Kultur Zeitalter der Bewusstseinsseele Ägyptisch-chaldäische Kultur Zeitalter der Bewusstseinsseele Griechisch-römische Kultur Mittelalter Alt-indische Kultur Persische Kultur"
    },
    {
        theme: "Goethe (Faust, Märchen)",
        ranges: [
            { start: 1882, end: 1925, intensity: 0.6 },
            { start: 1916, end: 1918, intensity: 0.9 }
        ],
    ...
    },
    {
        ...
        query: "Baugedanke Brand Menschheitsrepräsentant Kuppelmalerei Säulen Glasfenster"
    },
    {
        theme: "Hüter der Schwelle",
        ranges: [
            { start: 1904, end: 1924, intensity: 0.8 }
        ],
        query: "Hüter_der_Schwelle"
    },
{
        theme: "Kosmologie / Kosmogonie",
        ranges: [
            { start: 1904, end: 1910, intensity: 1.0 },
            { start: 1911, end: 1924, intensity: 0.6 }
        ],
        query: "Kosmologie Kosmogonie Alter Saturn Alte Sonne Alter Mond Erde Jupiter Venus Vulkan Alter Saturn Alte Sonne Alter Mond Tierkreis"
    },
        {
        theme: "Kulturen & Völker",
        ranges: [
            { start: 1904, end: 1924, intensity: 0.8 }
        ],
        query: "Volksseelen Mitteleuropa Deutsche_Volksseele Orientalische_Kultur"
    },
{
        ...
        theme: "Lebenspraxis",
        ranges: [
            { start: 1894, end: 1924, intensity: 0.8 }
        ],
        query: "Lebenskraft Lebenserfahrung Lebensfragen Lebensgesetze"
    },
{
        theme: "Meditation / Schulungsweg",
        ranges: [
    ...
    },
    {
        ...
        query: "Menschenkunde Dreigliederung Temperamente Nerven-Sinnes-System Rhythmisches System Stoffwechsel-Gliedmaßen-System Leib, Seele, Geist Rhythmisches System"
    },
    {
        theme: "Menschheitsentwicklung",
        ranges: [
            { start: 1904, end: 1924, intensity: 0.9 }
        ],
        query: "Menschheitsentwicklung Wurzelrassen Kulturepochen Menschheitsführer Kali_Yuga"
    },
    {
        theme: "Michael",
        ranges: [
            { start: 1923, end: 1924, intensity: 1.0 }
        ],
        query: "Michael Michael-Briefe Drache Michael-Zeitalter 1879"
    },
        {
        theme: "Moral",
        ranges: [
            { start: 1886, end: 1924, intensity: 0.8 }
        ],
        query: "Moralische_Weltordnung Moralische_Phantasie Moral"
    },
{
        theme: "Mysteriendramen",
        ranges: [
            { start: 1910, end: 1913, intensity: 1.0 }
        ],
        query: "Mysteriendramen"
    },
    {
        theme: "Mysterienwesen / Einweihung",
        ranges: [
            { start: 1902, end: 1902, intensity: 0.8 },
            { start: 1923, end: 1924, intensity: 1.0 }
        ],
    ...
    },
{
        ...
        query: "Naturreiche Mineralreich Pflanzenreich Tierreich Menschenreich Gruppenseelen"
    },
    {
        theme: "Naturwissenschaft / Mathematik",
        ranges: [
            { start: 1882, end: 1897, intensity: 0.7 },
            { start: 1919, end: 1925, intensity: 1.0 }
        ],
        query: "Naturwissenschaft Physik Chemie Biologie Geologie Astronomie Mathematik Anatomie"
    },
    {
        theme: "Pädagogik / Heilpädagogik",
        ranges: [
        ...
        query: "Aristoteles Plato Parmenides Heraklit Schopenhauer Fichte Hegel Schelling Eduard von Hartmann Philosophie Nietzsche Hartmann Kant Kantianismus Neukantianismus Philosophie Descartes Mittelalterliche_Philosophie"
    },
{
        theme: "Reinkarnation & Karma",
        ranges: [
            { start: 1903, end: 1923, intensity: 0.6 },
            { start: 1924, end: 1924, intensity: 1.0 }
        ],
        query: "Reinkarnation Karma Inkarnation Kamaloka Weltenmitternacht Schicksal Vorgeburtlichkeit Nachtodliches_Leben"
    },
    {
        theme: "Religionen / Weisheitslehren",
        ranges: [
            { start: 1903, end: 1924, intensity: 0.8 }
        ],
        query: "Religionen Weisheitslehren Buddhismus Hinduismus Islam Judentum Gnosis Mystik Esoterisches Christentum Okkultismus Esoterisches Christentum Christentum"
    },
        {
        theme: "Rhythmen & Zyklen",
        ranges: [
            { start: 1889, end: 1924, intensity: 0.8 }
        ],
        query: "Jahrsiebte Jahreszeiten Platonisches Weltenjahr Entwicklungszyklen 33-Jahre-Zyklus Kulturepochen Erzengel-Regentschaft"
    },
{
        theme: "Rosenkreuzer",
        ranges: [
        ...
        query: "Rosenkreuzer Rosenkreuzertum Christian Rosenkreutz Christian Rosenkreutz Chymische Hochzeit"
    },
        {
    ...
    },
{
        ...
        query: "Schlaf Tod Lebenstableau Erinnerungstableau Kamaloka Devachan Nachtodliches Leben Nachtodliches Leben"
    },
    {
        theme: "Seelenfähigkeiten",
        ranges: [
            { start: 1903, end: 1924, intensity: 0.6 },
            { start: 1910, end: 1910, intensity: 0.9 }
        ],
        query: "Denken Fühlen Wollen Gedächtnis Erinnerung Wahrnehmen Phantasie"
    },
        {
        theme: "Seelenlehre / Seelenglieder",
        ranges: [
            { start: 1903, end: 1918, intensity: 0.8 }
        ],
        query: "Empfindungsseele Verstandesseele Bewusstseinsselle Psychosophie Vegetative Seele Animalische Seele Vegetative Animalische Seele"
    },
{
        theme: "Sinneslehre",
        ranges: [
            { start: 1909, end: 1911, intensity: 0.8 },
            { start: 1919, end: 1924, intensity: 1.0 }
        ],
        query: "Sinneslehre Sinnesorganisation Ich-Sinn Gedanken-Sinn Laut-Sinn Wort-Sinn Lebens-Sinn Tast-Sinn Bewegungs-Sinn Geschmacks-Sinn Geruchs-Sinn Seh-Sinn Hör-Sinn Wärme-Sinn"
    },
    {
        theme: "Soziale Dreigliederung",
        ranges: [
            { start: 1905, end: 1906, intensity: 0.5 },
            { start: 1917, end: 1922, intensity: 1.0 }
        ],
        query: "Soziale_Dreigliederung Wirtschaftleben Rechtsleben Geistesleben Assoziationen Freiheit_Gleichheit_Brüderlichkeit"
    },
            {
        theme: "Spache",
        ranges: [
            { start: 1884, end: 1924, intensity: 0.8 }
        ],
        query: "Sprechenlernen Sprache Vokale Konsonanten Laute Worte Grammatik"
    },
{
        theme: "Theosophische Gesellschaft",
        ranges: [
            { start: 1902, end: 1923, intensity: 0.8 }
        ],
        query: "Theosophie Blavatsky Beasant Bruderbund"
    },
    {
        theme: "Tugenden",
        ranges: [
            { start: 1885, end: 1924, intensity: 0.8 }
        ],
    ...
    },
{
        ...
        query: "Elemente Feuer Luft Wasser Erde Äther Lebensäther Wärmeäther Lichtäther Klangäther Chemischer Äther"
    },
        {
        theme: "Weltanschauungen",
        ranges: [
            { start: 1904, end: 1924, intensity: 0.8 }
        ],
        query: "Agnostizismus Materialismus Spiritualismus Monismus Idealismus Neuplatonismus Pragmatismus Deuscher_Idealismus"
    },
{
        theme: "Wesensglieder",
        ranges: [
        ...
        query: "Wesensglieder Physischer Leib Ätherleib Astralleib Ich Geistselbst Lebensgeist Geistesmensch Manas Atma Physischer Leib Buddhi"
    },
    {
        theme: "Westen Mitte Osten",
        ranges: [
            { start: 1918, end: 1922, intensity: 1.0 },
