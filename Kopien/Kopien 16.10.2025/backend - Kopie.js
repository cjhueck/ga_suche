...
- Sachliche Aspekte (Was ist gemeint? Konkrete Phänomene, Substanzen, leibliche Prozesse)
- Funktionelle Aspekte (Wie verhält es sich? Funktionen, Wirkungsweisen, Prozesse, physiologische Aspekte)
...
- Vergleich mit anderen Inhalten (Verhältnis zu anderen Konzepten, Wesen, Naturreichen)
...
- Verwende Markdown-Formatierung
- **Fette wichtige Schlagwörter** und **zentrale Aussagen**
- Schreibe Zitate Steiners in Anführungszeichen mit Quellenangabe
- Zitiere nur prägnante, kurze Stellen wörtlich in "Anführungszeichen" mit Quellenangabe
- Gib nach jeder spezifischen Aussage die Quelle
- Zitate sollen kurz sein - nur das Wesentliche !important
- Vermeide Redundanzen - jede Information nur einmal 

QUELLENANGABEN:
- Gib nach spezifischen Aussage die Quelle an
- Format: (GA###/lectureNum:index) - z.B. (GA052/7:n5x6ru) oder (GA068a/7:p5fg67)
- Verfügbare Referenzen: ${availableRefs}
